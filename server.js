...
const hairType = {
    '4c': {
        ...
        'hair care tips' : ['Mosturize before styling', 'condition', 'wash and condition in sections'],
        'recommended products' : ['Camille Rose Naturals Sweet Ginger Cleansing Rinse', 'Messen EZ Detangling Brush', 'Mielle Organiscs Rosemary Mint Scalp & Hair Strengthening Oil', 'Mielle Organics Pomegranate & Honey Leave-in', 'Uncle Funky\'s daughter curly magic', 'Kinky curly knot today detangler'] ,
    ...
    '4b': {
        ...
        'hair care tips' : ['Moisturize', 'Condition', 'finger-Comb', 'style'],
        'recommended products' : ['Mielle Moisture RX Hawaiian Ginger Moisturizing Hair Butter', 'Messen EZ Detangling Brush', 'Soultanicals Knot Sauce Coil Detangler', 'Mielle Organics Avocado Hair Milk', 'Fresh Honey Nectar Deep Conditioning Treatment', 'The doux mousse def texture foam'] ,
    ...
    '4a': {
        ...
        'hair care tips' : ['Moisturize Regularly', 'Use Sulfate-Free Shampoo', 'Keep Your Scalp Healthy', 'Minimize Your Heat Usage', 'Be Careful With Hairstyles That Add Tension', 'Handle Your Hair With TLC', 'Sleep On a Satin Pillowcase'],
        'recommended products' : ['Carol\'s Daughter Hair Milk Original Leave-In Moisturizer', 'Tgin Green Tea Super Moist Leave In Conditioner', 'Pattern Jojoba Oil Hair Serum', 'Kinky Curly Original Curling Custard', 'Camille Rose Algae Renew Deep Conditioner', 'As I Am Restore & Repair Jamaican Black Castor Oil CoWash'],
    ...
    '3c': {
        ...
        'hair care tips' : ['Wash and condition thoroughly.', ' Deep-condition.', 'use a curl cream', 'apply a curl refresher', 'Use sulfate-free shampoo', 'Low manipulation styles'],
        'recommended products' : ['DevaCurl Melt Into Moisture Matcha Green Tea Butter Conditioning Mask', 'Kinder Curls Super Curls Styler', 'Camille Rose Aloe Whipped Butter Gel'],
    ...
    '3b': {
        ...
        'hair  care tips' : ['Layer products to build and retain moisture', 'Avoid heat as much as possible', 'Opt for lightweight leave-in products to avoid weighing hair down', 'Create (and follow) a comprehensive plan for daily care and protection'],
        'recommended products' : ['Strictly Curls Curl Envy Perfect Curl Cream', 'PATTERN Curl Gel', 'BLACK VANILLA MOISTURE & SHINE HYDRATING CONDITIONER', 'HAIR MILK ORIGINAL LEAVE-IN MOISTURIZER'],
    ...
    '3a': {
        ...
        'hair care tips' : ['Find the Wash Technique That Works for You', 'Master Second-Day (And Even Third-Day) Curls', 'Prioritize Lightweight Hydration Out of the Shower', ' Confirm your porosity', ' Detangle from tip to root', ' Quench your thirsty curls.', ],
        'recommended products' : ['Exotic Sulfate-free Biotin Shampoo, The Hair Doctor','Pink Collapsible Diffuser, Rizos Curls', 'Miracle Shake Leave In Detangler Spray, Kaleidoscope', '100% Pure Cold Pressed Organic Argan Oil, Pura D\'or\'s'],
